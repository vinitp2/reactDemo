      ...
      <div className='cards__container'>
        <div className='cards__werapper'>
            <ul className='cards__items'>
                ...
                <CardItem src='/images/img-2.jpg' text="Travel through the Island of Bali in a private cruise"
            ...
            <ul className='cards__items'>
                ...
                <CardItem src='/images/img-8.jpg' text="Ride through the Sahara Desert i a guided camel tour"
